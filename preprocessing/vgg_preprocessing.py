...
def preprocess_image(image, output_height, output_width, random_mirror, is_training=False,
                     resize_side_min=_RESIZE_SIDE_MIN,
                     resize_side_max=_RESIZE_SIDE_MAX):
  ...
  """
  if is_training:
    return preprocess_for_train(image, output_height, output_width, random_mirror,
