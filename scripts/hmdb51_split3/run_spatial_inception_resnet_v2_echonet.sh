...
if [ $MODE -eq 1 ]; then
    ...
    DATASET_LIST=/home/shiyemin/data/hmdb/trainlist03_list.txt
    ...
    # Where the dataset is saved to.
    DATASET_LIST=/home/shiyemin/data/hmdb/testlist03_list.txt
    ...
    for((i=0;i<${#GPUS[@]};i++));do
        ...
        # Where the dataset is saved to.
        DATASET_LIST=/home/shiyemin/data/hmdb/prepared_list/testlist03_0$i
        # Fine-tune only the new layers for 1000 steps.
        CUDA_VISIBLE_DEVICES=$GPU_ID python ${ROOT}train_video_classifier.py \
          --mode=extract \
          --train_dir=${TRAIN_DIR}/train \
