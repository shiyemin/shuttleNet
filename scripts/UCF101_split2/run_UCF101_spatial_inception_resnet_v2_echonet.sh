...
train_batch_size=32
TRAIN_DIR=UCF101_spatial_inception_resnet_v2_echonet
...
if [ $MODE -eq 1 ]; then
    ...
    DATASET_LIST=/home/shiyemin/data/ucf101/prepared_list/trainlist02_list.txt
    ...
    # Where the dataset is saved to.
    DATASET_LIST=/home/shiyemin/data/ucf101/prepared_list/testlist02_list.txt
    ...
    for((i=0;i<${#GPUS[@]};i++));do
        ...
        # Where the dataset is saved to.
        DATASET_LIST=/home/shiyemin/data/ucf101/prepared_list/split2/testlist02_0$i
        # Fine-tune only the new layers for 1000 steps.
        CUDA_VISIBLE_DEVICES=$GPU_ID python ${ROOT}train_video_classifier.py \
          --mode=extract \
          --train_dir=${TRAIN_DIR}/train \
