...
train_batch_size=32
TRAIN_DIR=HMDB51_spatial_inception_resnet_v2_echonet
DATASET_DIR=/home/shiyemin/data/hmdb/frames_tvl1
NUM_CLASSES=51
labels_offset=1
n_steps=16
modality=RGB
...
if [ $MODE -eq 1 ]; then
    ...
    DATASET_LIST=/home/shiyemin/data/hmdb/trainlist01_list.txt
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID python ${ROOT}train_video_classifier.py \
      ...
      --decay_iteration=2000,20000,25000,28000,31000 \
      --label_smoothing=0.1 \
    ...
    # Where the dataset is saved to.
    DATASET_LIST=/home/shiyemin/data/hmdb/testlist01_list.txt
    ...
    for((i=0;i<${#GPUS[@]};i++));do
        ...
        # Where the dataset is saved to.
        DATASET_LIST=/home/shiyemin/data/hmdb/prepared_list/testlist01_0$i
        # Fine-tune only the new layers for 1000 steps.
        CUDA_VISIBLE_DEVICES=$GPU_ID python ${ROOT}train_video_classifier.py \
          --mode=extract \
          --train_dir=${TRAIN_DIR}/train \
