...
def inception_resnet_v2_rnn(inputs, num_classes=1001, is_training=True,
...
def rnn_part(inputs, num_classes=1001, is_training=True,
                        dropout_keep_prob=0.8,
                        reuse=None,
                        scope='InceptionResnetV2'):
  end_points = {}
...
inception_resnet_v2_rnn.rnn_part = rnn_part
inception_resnet_v2_rnn.default_image_size = 299


def inception_resnet_v2_rnn_arg_scope(weight_decay=0.00004,
